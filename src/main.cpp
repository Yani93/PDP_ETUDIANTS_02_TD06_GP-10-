...
const char *wifi_ssid = <IPhoneYani>;
const char *wifi_password = <Yaniatek93>;
...
const char *client_id = <TD06_GP10>;
    ...
    
        {
          ...
          if (isnan(event.relative_humidity))
          {
            ...
            else
            {
              ...
              {
                mqtt_client.publish("TD06_GP10/temp"),String(temp_measure).c_str());
                mqtt_client.publish("TD06_GP10/relhum"),String(relative_humidity_measure).c_str());
                Serial.println("ok");
              }
